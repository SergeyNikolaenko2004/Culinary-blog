...
db.culture_plast = require('../model/culture_plast.model.js')(sequelize, Sequelize);
db.food_name = require('../model/food_name.model.js')(sequelize, Sequelize);
db.user = require('../model/user.model.js')(sequelize, Sequelize);
db.favorite = require('../model/favorite.model.js')(sequelize, Sequelize);
